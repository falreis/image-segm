...
% TODO: Adicionar informação sobre f-measure
...
% TODO Reescrever essa seção

Para avaliação das imagens, foi primeiramente utilizada a classificação visual, comparando a qualidade dos resultados. Em seguida utilizou-se um método de comparação de precisão e revocação, para detecção de contornos e bordas, conforme mostrado na Seção \ref{ssec:prec_recall}.
